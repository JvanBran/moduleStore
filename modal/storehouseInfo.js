...
const StorehouseInfo = Sequelize.import('../schema/storehouseInfo')
// 标准同步
...
class StorehouseInfoModel extends sqlClass{
    constructor(){
        super()
        this.sqlModel = StorehouseInfo;
        this.dataType = {
        }
    }
}
let storehouseInfo = new StorehouseInfoModel()
module.exports = {
